...
public class CarterasController {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getPagosJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getCarteraJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> get_cuentasJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> get_bancos_moneda_kemikalJson(
            @RequestParam(value = "id_moneda", required = true) Integer id_moneda,
            @RequestParam(value = "iu", required = true) String id_user_cod,
            Model model
    ) {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> get_obtener_numero_de_cuentaJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getObtenerAanticiposJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getObtenerFacturasJson(
            @RequestParam(value = "id_cliente", required = true) Integer id_cliente,
            Model model
    ) {
    ...
    public @ResponseBody
    HashMap<String, String> GeneraAnticipoJson(
    ...
    public @ResponseBody
    HashMap<String, String> CancelarPagosJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getObtenerMonedasJson(
            Model model
    ) {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getgetTiposMovimientoJson(
            Model model
    ) {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, String>>> getBuscarFacturasCancelarJson(
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, Object>>> getFacturasNumTransaccionJson(
            @RequestParam(value = "num_trans", required = true) String num_transaccion,
            Model model
    ) {
    ...
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, String>>> getNumTransaccionClienteJson(
            @RequestParam(value = "id_cliente", required = true) Integer id_cliente,
            Model model
    ) {
